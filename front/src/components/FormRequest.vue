...
export default {
  ...
  methods:{
        newRequest(){
            let date = {Start_date:this.start,End_date:this.end,Reason:this.Cause,
            Leave_Type:this.leave_Type,
            student_id:this.studentid,Status:this.Padding}
            if (this.start !=null && this.end !=null && this.Cause !="" && this.Leave_Type !=""){
  ...
  computed: {
    differentDate() {
        ...
        if(dateforLeave <0 || dateforLeave == 0){
          if ((this.start != "" && this.end != "") && (halfDate)) {
